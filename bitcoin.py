...
def wallet_import_format(xpriv, prefix="80", compressed="01"):
	token = checksum(prefix + xpriv + compressed)
	data = prefix + xpriv + compressed + token
...
def main():
	...
	wif = wallet_import_format(xpriv)
	print("compressed : ", compressed, "     prefix : ", prefix, "\n")
	print("xpriv : ", xpriv, "\nxpub : ", xpub, "\n\nxpub_hash : ", xpub_hash ,"\n\naddress : ", address, "\nWIF : ", wif)
